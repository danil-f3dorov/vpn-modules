...
public class BotClosePacket extends BotPacket {

    private final int channelId;
    public BotClosePacket(int channelId) {
        super(BotCommandType.CLOSE, ProtocolConstants.PROXY_CMD_MARKER);
    ...
    public byte[] toByteArray() {
        return new byte[]{
                (byte) BotPacket.PROXY_BOT_CLOSE,
                (byte) (BotPacket.PROXY_BOT_CLOSE >> 8),
