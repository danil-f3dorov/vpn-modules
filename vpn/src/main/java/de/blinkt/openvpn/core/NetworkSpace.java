...
public class NetworkSpace {
    ...
    static class ipAddress implements Comparable<ipAddress> {
        ...
        public boolean equals(Object o) {
            ...
            return (networkMask == on.networkMask) && on.getFirstAddress()
                    .equals(getFirstAddress());
        }
...
//            if (BuildConfig.DEBUG) Assert.assertNotNull(currentNet);
            if (nextNet == null || currentNet.getLastAddress()
                    .compareTo(nextNet.getFirstAddress()) == -1) {
                ...
                if (currentNet.getFirstAddress()
                        .equals(nextNet.getFirstAddress()) && currentNet.networkMask >= nextNet.networkMask) {
