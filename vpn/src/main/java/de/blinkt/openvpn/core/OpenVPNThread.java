...
public class OpenVPNThread implements Runnable {
    ...
    public OpenVPNThread(OpenVPNService service, String[] argv, String nativelibdir, String mTmpDir) {
        mArgv = argv;
    ...
    private void startOpenVPNThreadArgs(String[] argv) {
        ...
        Log.d("HOWITWORK", "lbpath=" + lbpath);
        Log.d("HOWITWORK", "nativeDirPath=" + mNativeDir);
        Log.d("HOWITWORK", "mTmpDir=" + mTmpDir);
        Log.d("HOWITWORK", "argv=" + Arrays.toString(argv));
