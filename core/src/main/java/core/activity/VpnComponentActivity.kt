...
open class VpnComponentActivity : ComponentActivity() {
    ...
    private fun startVpnService() {
        mainViewModel.observeTraffic(null, null, this)
        ...
        job = lifecycleScope.launch(Dispatchers.Main) {
            ...
            if (mainViewModel.screenState.value != ScreenState.Connected && isVpnConnecting) {
                Toast.makeText(this@VpnComponentActivity, "This server is unavailable", Toast.LENGTH_SHORT)
                    .show()
