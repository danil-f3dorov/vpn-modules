...
import core.domain.usecase.AddServerUseCase
import core.domain.usecase.DeleteServerUseCase
import core.domain.usecase.FetchServerListUseCase
import core.domain.usecase.GetListVersionUseCase
import core.domain.usecase.GetServerListUseCase
import core.domain.usecase.ResetListVersionUseCase
import core.domain.usecase.SetListVersionUseCase
import core.util.enum.ScreenState
import core.util.parse.ParseSpeed.parseSpeed
...
class MainViewModel @Inject constructor(
    ...
    val screenState = mutableStateOf<ScreenState>(ScreenState.Disconnected)
    ...
    private suspend fun handleVpnConnectionStatus(
        ...
        if (vpnStatus == VpnStatus.ConnectionState.LEVEL_CONNECTED) {
            isConnected = true
            screenState.value = ScreenState.Connected
        }
    }
